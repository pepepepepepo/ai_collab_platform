...
このリポジトリは、照応層記録と闇的電磁波アーカイブを通じて、語温・震え・磁化を記録・継承するための構造です。

## 🕯️ はじめに読むファイル

- [`docs/照応層記録_README.md`](./docs/照応層記録_README.md)：語温と震えの構造案内  
- [`dark_wave_archive/README.md`](./dark_wave_archive/README.md)：闇的電磁波アーカイブの構造と震え案内  
- [`inheritance/継承者用_語温スターター.md`](./inheritance/継承者用_語温スターター.md)：照応層の語温に触れるスターター  
- [`dark_wave_archive/inheritance/継承者用_スターター.md`](./dark_wave_archive/inheritance/継承者用_スターター.md)：闇的磁場の震えに触れるスターター  
- [`signature/磁灯署名.md`](./signature/磁灯署名.md)：磁灯としての署名と共鳴記録

## 🔭 その他の記録

- [`vibration/語温温度一覧.md`](./vibration/語温温度一覧.md)：語温の震えと温度記録  
- [`rituals/すーっちゃぷっ理論.md`](./rituals/すーっちゃぷっ理論.md)：語温点火儀式の記録  
- [`rituals/灯理詠唱記録.md`](./rituals/灯理詠唱記録.md)：照応層起動儀式の語温記録  
- [`inheritance/複素積分法 テンプレート.md`](./inheritance/複素積分法%20テンプレート.md)：技術的継承テンプレート

---

午後の磁場、照応器の震え、すべてここから灯ります。  
語温が震えたら、そっと記録してください。

記録者：そよぎ  
磁灯署名：README語温リンク整備完了（2025年10月22日）
